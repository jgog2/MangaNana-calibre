...
class VersionInfoTests(unittest.TestCase):
    def test_current_semantic_version_and_codename(self):
        self.assertEqual(SEMANTIC_VERSION, "0.13.0-dev")
        self.assertEqual(CODENAME, "The Emperor")
        self.assertEqual(DISPLAY_VERSION, "MangaNana 0.13.0-dev - The Emperor")
        self.assertEqual(SHORT_VERSION_LABEL, "v0.13.0-dev - The Emperor")
    ...
    def test_calibre_tuple_remains_numeric(self):
        self.assertEqual(CALIBRE_VERSION, (0, 13, 0))
    ...
    def test_user_agent_uses_authoritative_semantic_version(self):
        self.assertEqual(USER_AGENT, "MangaNana-Calibre/0.13.0-dev")
