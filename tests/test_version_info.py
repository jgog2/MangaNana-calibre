...
class VersionInfoTests(unittest.TestCase):
    def test_current_semantic_version_and_codename(self):
        self.assertEqual(SEMANTIC_VERSION, "0.12.0-dev")
        self.assertEqual(CODENAME, "The Empress")
        self.assertEqual(DISPLAY_VERSION, "MangaNana 0.12.0-dev — The Empress")
        self.assertEqual(SHORT_VERSION_LABEL, "v0.12.0-dev — The Empress")
    ...
    def test_calibre_tuple_remains_numeric(self):
        self.assertEqual(CALIBRE_VERSION, (0, 12, 0))
    ...
    def test_user_agent_uses_authoritative_semantic_version(self):
        self.assertEqual(USER_AGENT, "MangaNana-Calibre/0.12.0-dev")
